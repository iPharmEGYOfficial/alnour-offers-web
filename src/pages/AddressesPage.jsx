      ...
      <main className="container account-layout">
        ...
        <section className="account-main">
          <div className="hero-card">
            ...
            <p className="subtle">
              Add delivery addresses and choose the default address used during checkout.
            </p>
          </div>
          ...
          <div className="home-section">
            <div className="section-head">
              <div>
                ...
                <p>Manage all saved addresses and mark one as the default delivery option.</p>
              </div>
            </div>

            {addresses.length === 0 ? (
              <div className="status-box">No saved addresses yet.</div>
            ) : (
